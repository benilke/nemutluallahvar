...
if(!["789221100306432020"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
//-------------------------------------------------------------------------------\\
  ...
  message.guild.roles.cache.get("774612729394102272" ,"").members.map(r => {
